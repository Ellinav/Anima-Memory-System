            ...
            <div class="anima-modal-body">
                <div class="anima-input-group" style="flex-direction: column;">
                    ...
                    <select id="anima_new_regex_type" class="anima-select">
                        <option value="extract">🔍 提取 (Extract)</option>
                        <option value="exclude">🚫 排除 (Exclude)</option>
                    </select>
                </div>
                <div class="anima-input-group" style="flex-direction: column;">
                    <label>正则表达式</label>
                    <input type="text" id="anima_new_regex_str" class="anima-input" placeholder="/<snapshot>(.*?)<\\/snapshot>/gs">
                </div>
            </div>
